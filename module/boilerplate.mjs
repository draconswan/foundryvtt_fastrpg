...
Hooks.once('init', function () {
  ...
  CONFIG.Combat.initiative = {
    formula: '1d6 + (@abilities.dex.value + @abilities.int.value)/2.0',
    decimals: 2,
  };
  ...
  CONFIG.Skill.documentClass = BoilerplateSkill;
  CONFIG.Power.documentClass = BoilerplatePower;
  CONFIG.Benefit.documentClass = BoilerplateBenefit;
